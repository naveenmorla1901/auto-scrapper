...
def generate_example_output(data_description: str) -> str:
    ...
    # Create example output based on the first matched data type
    example_data = {"results": [data_types[matched_types[0]]]}
    
    # If multiple items are expected, add another example
    if "list" in description_lower or "multiple" in description_lower:
